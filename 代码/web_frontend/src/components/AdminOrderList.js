...
import { withRouter } from 'react-router';
  ...
  export class AdminOrderListWWrapper extends React.Component{
    render() {
      const { props, userId } = this.props.location.state || {};
      console.log('AdminOrderListWWrapper props: ', props);
      // console.log('AdminOrderListWWrapper groupId: ', groupId);
      console.log('AdminOrderListWWrapper userId: ', userId);
      return(
          <AdminOrderList userId={userId} props={props}/>
      );
    }
  }

  
  const AdminOrderList = ({userId, props}) => {
    const toast = useToast();
    // const {userId} = route.params;
    // console.log('adminorderlist1', props.userId);
    console.log('AdminOrderList ---userId: ', userId)
    console.log('AdminOrderList ---props: ', props)
    ...
    const onGetOrders = () => {
      const data = {groupId: parseInt(group.props.groupId)};
