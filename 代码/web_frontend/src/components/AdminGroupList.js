...
export class AdminGroupListWrapper extends React.Component {
  render() {
    const { userId } = this.props.location.state || {};
    console.log("detail screen wrapper userId: ", userId);
    return <AdminGroupList userId={userId} />;
  }
}

const AdminGroupList = ({ userId }) => {
  //   const userId = route.params.userId;
  console.log("AdminGroupList ---userId: ", userId);
              ...
              >
                <HStack>
                  ...
                  >
                    <Link
                      to={{
                        pathname: "/AdminOrderList",
                        state: { userId: userId, props: item },
                      }}
                    >
                      <Image
                        // mt="15%"
